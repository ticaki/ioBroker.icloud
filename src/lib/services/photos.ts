...
type FieldResValue = { size: number; downloadURL: string; fileChecksum?: string; wrappingKey?: string; referenceChecksum?: string };
type PhotoVersion = { filename: string; width: number | undefined; height: number | undefined; size: number | undefined; url: string | undefined; type: string | undefined };
...
export class iCloudPhotosEndpointService {
    ...
    constructor(private serviceUri: string, private headers: string[][] | Record<string, string | ReadonlyArray<string>> | Headers, private _fetchFn: iCloudService["fetch"]) {}
    /* eslint-enable no-useless-constructor, no-empty-function */
    async fetch<T = unknown>(url: string, body?: object, headers?: string[][] | Record<string, string | ReadonlyArray<string>> | Headers): Promise<T> {
